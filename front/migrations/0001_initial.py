    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brief', models.CharField(max_length=512, verbose_name='名称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_fake', models.IntegerField(verbose_name='如果是爬虫抓的话，就给这个字段1')),
                ('brief_intro', models.CharField(max_length=255, verbose_name='个人简介')),
                ('join_ip', models.CharField(max_length=16, verbose_name='加入ip')),
                ('join_time', models.DateTimeField(default=django.db.models.functions.base.Now(), verbose_name='加入时间')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=64, verbose_name='名称')),
                ('last_modify_time', models.DateTimeField(default=django.db.models.functions.base.Now())),
                ('add_time', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=64, verbose_name='名称')),
                ('add_time', models.DateTimeField(auto_now_add=True)),
                ('category_type', models.ManyToManyField(to='front.CategoryType')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('usage', models.CharField(max_length=64, verbose_name='用量')),
